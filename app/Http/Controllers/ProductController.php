        ...
        if(request()->ajax())
        {
            ...
            ->addColumn('action', function ($item){
                return '
                    ...
                    <a href="' . route('dashboard.product.gallery.index', $item->id) . '" class="bg-blue-500 text-white rounded-md px-2 py-1 m-2 mr-2">
                    ...
                    <a href="' . route('dashboard.product.edit', $item->id) . '" class="bg-yellow-500 text-white rounded-md px-2 py-1 m-2 mr-2">
