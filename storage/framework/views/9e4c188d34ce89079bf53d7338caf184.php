      ...
      <section class="container mx-auto">
        <div class="flex flex-wrap my-4 md:my-12">
          <div class="w-full md:hidden px-4">
            ...
            <span class="text-xl">Rp <?php echo e(number_format($product->price)); ?></span>
          </div>
          <div class="flex-1">
            <div class="slider">
              <div class="thumbnail">
                ...
                <div class="px-2">
                  <div
                    class="item <?php echo e($loop->first ? 'selected' : ''); ?>"
                    data-img="<?php echo e(Storage::url($item->url)); ?>"
                  >
                    <img
                      src="<?php echo e(Storage::url($item->url)); ?>"
                      alt="front"
              ...
              <div class="preview">
                <div class="item rounded-lg h-full overflow-hidden">
                  <img
                    src="<?php echo e($product->galleries()->exists() ? Storage::url($product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>"
                    alt="front"
                    class="object-cover w-full h-full rounded-lg"
                  />
                </div>
          ...
          <div class="flex-1 px-4 md:p-6">
            <h2 class="text-5xl font-semibold"><?php echo e($product->name); ?></h2>
            <p class="text-xl">Rp <?php echo e(number_format($product->price)); ?></p>
            ...
            <div class="px-3 flex-none" style="width: 320px">
              <div class="rounded-xl p-4 pb-8 relative bg-slate-100">
                <div class="rounded-xl overflow-hidden card-shadow w-full h-50 bg-white">
                  <img
                    src="<?php echo e($recomendation->galleries()->exists() ? Storage::url($recomendation->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>"
                    alt=""
                    class="w-full h-full object-cover object-center"
                  />
                </div>
                <h5 class="text-lg font-semibold mt-4"><?php echo e($recomendation->name); ?></h5>
                <span class="">Rp <?php echo e(number_format($recomendation->price)); ?></span>
                <a href="<?php echo e(route('details', $recomendation->slug)); ?>" class="stretched-link">
                </a>
              </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop-app-new\resources\views/pages/frontend/details.blade.php ENDPATH**/ ?>