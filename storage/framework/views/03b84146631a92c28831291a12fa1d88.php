...
<?php endif; ?>
            ...
            <div>
                <p>Don't have an account? <a href="<?php echo e(route('register')); ?>"  <?php echo e(\Route::current()->getName() == 'index'); ?> style="color:blue">Register now!</a></p>
            </div>
        </form>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\shop-app-new\resources\views/auth/login.blade.php ENDPATH**/ ?>