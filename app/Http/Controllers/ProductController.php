        ...
        if(request()->ajax())
        {
            ...
            ->addColumn('action', function ($item){
                return '
                    ...
                    <a href="' . route('dashboard.product.gallery.index', $item->id) . '" class="bg-red-500 text-black rounded-md px-2 py-1 m-2 mr-2">
                    ...
                    <a href="' . route('dashboard.product.edit', $item->id) . '" class="bg-gray-500 text-white rounded-md px-2 py-1 m-2 mr-2">
