    ...
    <header class="<?php echo e(\Route::current()->getName() == 'index' ? 'absolute' : ''); ?> w-full z-50 px-4">
            ...
            <div class="w-auto">
              ...
              >
                <li class="mx-3 py-6 md:py-0">
                  <a href="#home" class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                    >Beranda</a
                  >
                </li>
                <li class="mx-3 py-6 md:py-0 ">
                  <a href="#tentang" class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                    >Tentang</a
                  >
                </li>
                <li class="mx-3 py-6 md:py-0">
                  <a href="#menu_index" class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                    >Menu</a
                  >
                </li>
                <li class="mx-3 py-6 md:py-0">
                  <a href="#kontak" class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                    >Kontak</a
                  >
                </li>
                <?php if(auth()->guard()->check()): ?>
                <li class="mx-3 py-6 md:py-0">
                  <a href="<?php echo e(route('dashboard.index')); ?>" class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                    >Dashboard</a
                  >
                </li>
                <?php endif; ?>
                ...
                <li class="mx-3 py-6 md:py-0">
                  <a href="<?php echo e(route('login')); ?>" class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline"
                    >Login</a
                  >
                </li>
                <?php endif; ?>
      ...
      <!-- END: HEADER --><?php /**PATH C:\xampp\htdocs\shop-app-new\resources\views/components/frontend/navbar.blade.php ENDPATH**/ ?>