        ...
        <!-- END: ABOUT -->
                    ...
                    <div class="px-4 mb-4 w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4">
                      <div class="relative card group">
                        <div class="rounded-xl overflow-hidden card-shadow relative bg-green-100"
                          ...
                          <img src="{{ asset('storage/' . $product->galleries->first()->url) }}" alt=""
          ...
          <section id="kontak" class="bg-slate-50 dark:bg-gray-900">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                @if (Session::has('msg'))
                    <p class="p-4 mb-4 text-md text-white rounded-lg bg-green-300 dark:bg-gray-800 dark:text-green-400" role="alert"> {{ Session::get('msg') }}</p>
                @endif
